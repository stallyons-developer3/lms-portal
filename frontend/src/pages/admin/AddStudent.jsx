...
const AddStudent = () => {
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      notify.error(err.response?.data?.message || `Failed to ${isEdit ? 'update' : 'create'} student`);
    } finally {
      setSubmitting(false);
    }
  };
      ...
      <div className="card form-pill">
        <form onSubmit={handleSave}>
          ...
          <div className="form-row">
            ...
            <div className="form-group">
              <label>Age</label>
              <input type="number" value={age} onChange={(e) => setAge(e.target.value)} placeholder="enter" min={0} />
            </div>
          </div>
